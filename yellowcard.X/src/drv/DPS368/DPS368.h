...
typedef enum
{
    NO_RESULTS, PRES_READY, TEMP_READY, BOTH_READY
} DPS368_resultStatus_t;


//Initialization Functions
extern uint32_t initializeDPS368(DPS368_precision_t presOversample,    //Initialize DPS368 Function, configures the sensor to behave with the desired operating traits
                                 DPS368_background_t presMeasureRate,
                                 DPS368_precision_t tempOversample,
                                 DPS368_background_t tempMeasureRate,
                                 uint32_t enableFIFO);

//Interaction Functions
extern uint32_t setModeDPS368(DPS368_sensorMode_t newMode);            //Set Mode Function, changes the operating mode of the sensor to the given mode
extern DPS368_resultStatus_t getResultStatusDPS368();                  //Get Result Status Function, provides the status of whether measurement results are ready or not
